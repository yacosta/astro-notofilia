...
function buildTemplate(lang) {
  ...
  const related = isEs
    ? [
        ...
        ['/coleccion/filipinas/5-pesos-victory-series-66/', '5 Pesos Victory Series No. 66'],
    ...
    : [
        ...
        ['/en/collection/philippines/5-pesos-victory-series-66/', '5 Pesos Victory Series No. 66'],
