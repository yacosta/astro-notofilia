 ...
 *
 * Usage:
 *   SOURCE=/path/to/original.png node scripts/process-filipinas-2-pesos-victory-image.mjs
 */
...
const SLUG = `philippines-treasury-certificate-2-pesos-victory-series-66-${HASH}`;
