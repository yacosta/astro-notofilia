...
export const RECENT_PIECES: RecentPiece[] = [
  ...
  },
  {
    ...
    description:
      'Prueba de impresión progresiva o parcial del 2.000 pesos (2.08.2016): retrato en blanco, reverso impreso, series AA visibles.',
    descriptionEn:
      'Progressive or partial printing proof of the 2,000-peso note (2.08.2016): unprinted portrait, printed reverse, visible AA serials.',
    imageBase: 'colombia-banco-de-la-republica-2000-pesos-debora-arango-prueba-anverso',
    imageAlt:
      'Prueba de impresión progresiva del 2.000 pesos del Banco de la República con Débora Arango (P-458b): anverso incompleto y reverso de Caño Cristales impreso',
  },
  {
